...
module.exports.router = function(options) {
	...
	var feedURL = configParams.get("orion_autoUpdater_url");
	...
	.post('/downloadUpdates', function (req, res) {
		...
		var updateChannel = (allPrefs.Properties && allPrefs.Properties["updateChannel/name"]) || configParams.get("orion_autoUpdater_defaultChannel");
