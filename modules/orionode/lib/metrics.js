	...
	return express.Router()
		...
		.get('*', /* @callback */ function (req, res) {
			...
			return res.status(200).json({
				tid: options.configParams.get("orion_metrics_google_tid"),
				siteSpeedSampleRate: Math.min(100, Math.max(0, Number(options.configParams.get("orion_metrics_google_tid")))) || undefined
			});
		});
};